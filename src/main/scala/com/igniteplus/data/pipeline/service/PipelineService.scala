...
object PipelineService
{
  def pipelineService () : Unit  =
  {
    ...
    val notNullClickstreamDf:DataFrame=removeNull(validatedClickstremDf,SEQ_CLICKSTREAM_PRIMARY_KEYS,INPUT_NULL_CLICKSTREAM_DATA,CSV_FILE_TYPE)
    val notNullItemDf:DataFrame=removeNull(itemDf,SEQ_ITEM_PRIMARY_KEYS,INPUT_NULL_ITEM_DATA,CSV_FILE_TYPE)
